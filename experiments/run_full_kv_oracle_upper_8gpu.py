#!/usr/bin/env python3
"""Run and merge full KV Retrieval for the 8192+1024 oracle configuration."""
...
RUNNER = WORK / "experiments/run_kv_oracle_infinitebench.py"
...
ROOT = (
    WORK
    / "experiments/outputs"
    / "infinitebench_llama31_oracle_residual8192_1024_fullkv_8gpu_20260824"
)
...
def is_complete(gpu: int, start: int, end: int) -> bool:
    ...
    try:
        ...
        return (
            ...
            and online["residual_mode"] == "oracle"
            and online["shared_topk_budget"] == 8192
            and online["oracle_residual_tokens_per_nonrepresentative_head_row"]
            == 1024
            and online["oracle_member_topk_budget"] == 8192
        )
        ...
        json.dumps(
            {
                ...
                "task": TASK,
                "count": TOTAL,
                "configuration": {"shared": 8192, "residual": 1024},
